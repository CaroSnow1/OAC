...
SIGNAL \secuenciador|Inc|Add0~3_combout\ : std_logic;
...
-- pragma translate_on
PORT MAP (
	i => \secuenciador|MuxDireccion|salida[1]~7_combout\,
	devoe => ww_devoe,
...
-- pragma translate_on
PORT MAP (
	i => \secuenciador|MuxDireccion|salida[0]~9_combout\,
	devoe => ww_devoe,
...
-- Equation(s):
-- \inst|Mux3~0_combout\ = (\secuenciador|MuxDireccion|salida[3]~2_combout\ & (\secuenciador|MuxDireccion|salida[0]~9_combout\ & (!\secuenciador|MuxDireccion|salida[2]~4_combout\))) # (!\secuenciador|MuxDireccion|salida[3]~2_combout\ & 
-- (\secuenciador|MuxDireccion|salida[2]~4_combout\ & (\secuenciador|MuxDireccion|salida[0]~9_combout\ $ (!\secuenciador|MuxDireccion|salida[1]~7_combout\))))
...
PORT MAP (
	...
	datab => \secuenciador|MuxDireccion|salida[0]~9_combout\,
...
-- Equation(s):
-- \secuenciador|MicroPC|internal_value[0]~0_combout\ = !\secuenciador|MuxDireccion|salida[0]~9_combout\
...
-- Equation(s):
-- \inst|Mux2~0_combout\ = (\secuenciador|MuxDireccion|salida[0]~9_combout\ & (!\secuenciador|MuxDireccion|salida[2]~4_combout\ & !\secuenciador|MuxDireccion|salida[1]~7_combout\))
...
-- Equation(s):
-- \inst|Mux1~0_combout\ = (\secuenciador|MuxDireccion|salida[0]~9_combout\ & (\secuenciador|MuxDireccion|salida[2]~4_combout\ & ((!\secuenciador|MuxDireccion|salida[1]~7_combout\)))) # (!\secuenciador|MuxDireccion|salida[0]~9_combout\ & 
-- ((\secuenciador|MuxDireccion|salida[3]~2_combout\) # ((\secuenciador|MuxDireccion|salida[2]~4_combout\ & \secuenciador|MuxDireccion|salida[1]~7_combout\))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "0011001010111000",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \inst|Mux0~0_combout\ = (\secuenciador|MuxDireccion|salida[3]~2_combout\ & (((!\secuenciador|MuxDireccion|salida[1]~7_combout\) # (!\secuenciador|MuxDireccion|salida[0]~9_combout\)))) # (!\secuenciador|MuxDireccion|salida[3]~2_combout\ & 
-- (\secuenciador|MuxDireccion|salida[2]~4_combout\ & ((\secuenciador|MuxDireccion|salida[1]~7_combout\))))
...
-- Equation(s):
-- \secuenciador|IntLogic|sel~7_combout\ = (\Prueba|internal_value\(0) & (((\Prueba|internal_value\(1))) # (!\Y~input_o\))) # (!\Prueba|internal_value\(0) & (((\secuenciador|IntLogic|sel~6_combout\))))
...
-- Equation(s):
-- \secuenciador|Inc|Add0~4_combout\ = \secuenciador|MuxDireccion|salida[1]~7_combout\ $ (((\secuenciador|IntLogic|sel~8_combout\ & ((\secuenciador|MuxDireccion|salida[0]~8_combout\))) # (!\secuenciador|IntLogic|sel~8_combout\ & 
-- (\secuenciador|MicroPC|internal_value\(0)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \secuenciador|MicroPC|internal_value\(0),
...
-- Equation(s):
-- \inst|Mux7~0_combout\ = (!\secuenciador|MuxDireccion|salida[3]~2_combout\ & ((\secuenciador|MuxDireccion|salida[1]~7_combout\ & (!\secuenciador|MuxDireccion|salida[0]~9_combout\ & \secuenciador|MuxDireccion|salida[2]~4_combout\)) # 
-- (!\secuenciador|MuxDireccion|salida[1]~7_combout\ & (\secuenciador|MuxDireccion|salida[0]~9_combout\))))
...
PORT MAP (
	dataa => \secuenciador|MuxDireccion|salida[3]~2_combout\,
	datab => \secuenciador|MuxDireccion|salida[1]~7_combout\,
	datac => \secuenciador|MuxDireccion|salida[0]~9_combout\,
...
-- Equation(s):
-- \secuenciador|MuxDireccion|salida[1]~5_combout\ = (\Instrucciones|internal_value\(0) & ((\Instrucciones|internal_value\(1) & ((\R_Interru|internal_value\(1)))) # (!\Instrucciones|internal_value\(1) & (\LIGA|internal_value\(1))))) # 
...
-- Equation(s):
-- \secuenciador|MuxDireccion|salida[1]~6_combout\ = (\Instrucciones|internal_value\(0) & (((\secuenciador|MicroPC|internal_value\(1))))) # (!\Instrucciones|internal_value\(0) & ((\Instrucciones|internal_value\(1) & 
-- ((\secuenciador|MuxDireccion|salida[1]~5_combout\))) # (!\Instrucciones|internal_value\(1) & (\secuenciador|MicroPC|internal_value\(1)))))
...
PORT MAP (
	...
	datad => \secuenciador|MuxDireccion|salida[1]~5_combout\,
...
-- Equation(s):
-- \secuenciador|IntLogic|sel~1_combout\ = (\Prueba|internal_value\(1) & (((\Prueba|internal_value\(0)) # (!\INT~input_o\)))) # (!\Prueba|internal_value\(1) & (!\Y~input_o\ & ((\Prueba|internal_value\(0)))))
...
-- Equation(s):
-- \secuenciador|IntLogic|sel~0_combout\ = (!\X~input_o\ & (!\Prueba|internal_value\(1) & !\Prueba|internal_value\(0)))
...
-- Equation(s):
-- \secuenciador|IntLogic|sel~2_combout\ = (\Instrucciones|internal_value\(0) & (\VF|internal_value~q\ & ((\secuenciador|IntLogic|sel~1_combout\) # (\secuenciador|IntLogic|sel~0_combout\))))
...
PORT MAP (
	...
	datac => \secuenciador|IntLogic|sel~1_combout\,
	datad => \secuenciador|IntLogic|sel~0_combout\,
	combout => \secuenciador|IntLogic|sel~2_combout\);

-- Location: LCCOMB_X57_Y53_N26
\secuenciador|IntLogic|sel~3\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \secuenciador|IntLogic|sel~3_combout\ = (\Prueba|internal_value\(1) & (\INT~input_o\ & !\VF|internal_value~q\)) # (!\Prueba|internal_value\(1) & ((\VF|internal_value~q\)))
...
PORT MAP (
	datab => \INT~input_o\,
	datac => \Prueba|internal_value\(1),
	datad => \VF|internal_value~q\,
	combout => \secuenciador|IntLogic|sel~3_combout\);

-- Location: LCCOMB_X57_Y53_N8
\secuenciador|IntLogic|sel~4\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \secuenciador|IntLogic|sel~4_combout\ = (\Prueba|internal_value\(1) & (((\Prueba|internal_value\(0))))) # (!\Prueba|internal_value\(1) & ((\Prueba|internal_value\(0) & ((\Y~input_o\))) # (!\Prueba|internal_value\(0) & (\X~input_o\))))
...
-- Equation(s):
-- \secuenciador|IntLogic|sel~5_combout\ = (\Instrucciones|internal_value\(0) & ((\Prueba|internal_value\(1) & (\secuenciador|IntLogic|sel~3_combout\ & !\secuenciador|IntLogic|sel~4_combout\)) # (!\Prueba|internal_value\(1) & 
-- (!\secuenciador|IntLogic|sel~3_combout\ & \secuenciador|IntLogic|sel~4_combout\))))
...
-- Equation(s):
-- \secuenciador|MuxDireccion|salida[1]~7_combout\ = (\secuenciador|IntLogic|sel~2_combout\ & (((\secuenciador|MuxDireccion|salida[1]~5_combout\)))) # (!\secuenciador|IntLogic|sel~2_combout\ & ((\secuenciador|IntLogic|sel~5_combout\ & 
-- ((\secuenciador|MuxDireccion|salida[1]~5_combout\))) # (!\secuenciador|IntLogic|sel~5_combout\ & (\secuenciador|MuxDireccion|salida[1]~6_combout\))))
...
PORT MAP (
	...
	datad => \secuenciador|IntLogic|sel~5_combout\,
	combout => \secuenciador|MuxDireccion|salida[1]~7_combout\);

-- Location: LCCOMB_X58_Y53_N0
\secuenciador|Inc|Add0~3\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \secuenciador|Inc|Add0~3_combout\ = \secuenciador|MuxDireccion|salida[2]~4_combout\ $ (((\secuenciador|MuxDireccion|salida[0]~9_combout\ & \secuenciador|MuxDireccion|salida[1]~7_combout\)))
...
PORT MAP (
	...
	datac => \secuenciador|MuxDireccion|salida[2]~4_combout\,
	datad => \secuenciador|MuxDireccion|salida[1]~7_combout\,
	combout => \secuenciador|Inc|Add0~3_combout\);
...
PORT MAP (
	clk => \inst2|cuenta[27]~clkctrl_outclk\,
	d => \secuenciador|Inc|Add0~3_combout\,
	clrn => \RESET~input_o\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \inst|Mux6~0_combout\ = (\secuenciador|MuxDireccion|salida[0]~9_combout\ & (!\secuenciador|MuxDireccion|salida[1]~7_combout\ & (!\secuenciador|MuxDireccion|salida[3]~2_combout\ & !\secuenciador|MuxDireccion|salida[2]~4_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \secuenciador|MuxDireccion|salida[0]~9_combout\,
	datab => \secuenciador|MuxDireccion|salida[1]~7_combout\,
	datac => \secuenciador|MuxDireccion|salida[3]~2_combout\,
	datad => \secuenciador|MuxDireccion|salida[2]~4_combout\,
...
PORT MAP (
	...
	datac => \secuenciador|MuxDireccion|salida[2]~3_combout\,
...
-- Equation(s):
-- \inst|Mux8~0_combout\ = (!\secuenciador|MuxDireccion|salida[2]~4_combout\ & (!\secuenciador|MuxDireccion|salida[1]~7_combout\ & (\secuenciador|MuxDireccion|salida[0]~9_combout\ $ (\secuenciador|MuxDireccion|salida[3]~2_combout\))))
...
-- Equation(s):
-- \secuenciador|MuxDireccion|salida[0]~8_combout\ = (\Instrucciones|internal_value\(1) & (((\R_Interru|internal_value\(0))))) # (!\Instrucciones|internal_value\(1) & ((\Instrucciones|internal_value\(0) & (\LIGA|internal_value\(0))) # 
...
-- Equation(s):
-- \secuenciador|MuxDireccion|salida[0]~9_combout\ = (\secuenciador|IntLogic|sel~8_combout\ & (\secuenciador|MuxDireccion|salida[0]~8_combout\)) # (!\secuenciador|IntLogic|sel~8_combout\ & ((\secuenciador|MicroPC|internal_value\(0))))
...
-- Equation(s):
-- \inst|Mux4~0_combout\ = (\secuenciador|MuxDireccion|salida[1]~7_combout\ & ((\secuenciador|MuxDireccion|salida[3]~2_combout\ & (!\secuenciador|MuxDireccion|salida[0]~9_combout\)) # (!\secuenciador|MuxDireccion|salida[3]~2_combout\ & 
-- ((\secuenciador|MuxDireccion|salida[2]~4_combout\))))) # (!\secuenciador|MuxDireccion|salida[1]~7_combout\ & ((\secuenciador|MuxDireccion|salida[0]~9_combout\) # ((\secuenciador|MuxDireccion|salida[3]~2_combout\))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "0111111001110010",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \secuenciador|MuxDireccion|salida[0]~9_combout\,
...
-- Equation(s):
-- \inst|Mux5~0_combout\ = (!\secuenciador|MuxDireccion|salida[3]~2_combout\ & (\secuenciador|MuxDireccion|salida[0]~9_combout\ & (\secuenciador|MuxDireccion|salida[2]~4_combout\ & !\secuenciador|MuxDireccion|salida[1]~7_combout\)))
...
-- Equation(s):
-- \secuenciador|Inc|Add0~2_combout\ = \secuenciador|MuxDireccion|salida[3]~2_combout\ $ (((\secuenciador|MuxDireccion|salida[0]~9_combout\ & (\secuenciador|MuxDireccion|salida[2]~4_combout\ & \secuenciador|MuxDireccion|salida[1]~7_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \secuenciador|MuxDireccion|salida[3]~0_combout\,
	datab => \secuenciador|MuxDireccion|salida[3]~1_combout\,
	datac => \secuenciador|IntLogic|sel~2_combout\,
	datad => \secuenciador|IntLogic|sel~5_combout\,
...
-- Equation(s):
-- \inst|Mux9~0_combout\ = (\secuenciador|MuxDireccion|salida[3]~2_combout\ & (!\secuenciador|MuxDireccion|salida[1]~7_combout\ & (\secuenciador|MuxDireccion|salida[0]~9_combout\ $ (!\secuenciador|MuxDireccion|salida[2]~4_combout\))))
...
-- Equation(s):
-- \inst|Mux10~0_combout\ = (\secuenciador|MuxDireccion|salida[2]~4_combout\ & (\secuenciador|MuxDireccion|salida[3]~2_combout\ $ (((\secuenciador|MuxDireccion|salida[0]~9_combout\) # (!\secuenciador|MuxDireccion|salida[1]~7_combout\)))))
...
-- Equation(s):
-- \inst|Mux11~0_combout\ = (\secuenciador|MuxDireccion|salida[0]~9_combout\ & ((\secuenciador|MuxDireccion|salida[3]~2_combout\ & (!\secuenciador|MuxDireccion|salida[1]~7_combout\)) # (!\secuenciador|MuxDireccion|salida[3]~2_combout\ & 
-- ((!\secuenciador|MuxDireccion|salida[2]~4_combout\))))) # (!\secuenciador|MuxDireccion|salida[0]~9_combout\ & (\secuenciador|MuxDireccion|salida[1]~7_combout\ & (!\secuenciador|MuxDireccion|salida[3]~2_combout\ & 
-- \secuenciador|MuxDireccion|salida[2]~4_combout\)))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "0010010000101010",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \secuenciador|MuxDireccion|salida[0]~9_combout\,
...
-- Equation(s):
-- \inst|Mux12~0_combout\ = (\secuenciador|MuxDireccion|salida[0]~9_combout\ & (!\secuenciador|MuxDireccion|salida[2]~4_combout\ & (\secuenciador|MuxDireccion|salida[1]~7_combout\ $ (!\secuenciador|MuxDireccion|salida[3]~2_combout\)))) # 
-- (!\secuenciador|MuxDireccion|salida[0]~9_combout\ & (!\secuenciador|MuxDireccion|salida[1]~7_combout\ & (\secuenciador|MuxDireccion|salida[3]~2_combout\ & \secuenciador|MuxDireccion|salida[2]~4_combout\)))
...
-- Equation(s):
-- \inst|Mux13~0_combout\ = (\secuenciador|MuxDireccion|salida[1]~7_combout\ & ((\secuenciador|MuxDireccion|salida[3]~2_combout\ & (!\secuenciador|MuxDireccion|salida[0]~9_combout\ & \secuenciador|MuxDireccion|salida[2]~4_combout\)) # 
-- (!\secuenciador|MuxDireccion|salida[3]~2_combout\ & ((!\secuenciador|MuxDireccion|salida[2]~4_combout\))))) # (!\secuenciador|MuxDireccion|salida[1]~7_combout\ & (\secuenciador|MuxDireccion|salida[0]~9_combout\ & 
-- ((!\secuenciador|MuxDireccion|salida[2]~4_combout\) # (!\secuenciador|MuxDireccion|salida[3]~2_combout\))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "0100001000101110",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \secuenciador|MuxDireccion|salida[0]~9_combout\,
...
-- Equation(s):
-- \inst|Mux14~0_combout\ = (\secuenciador|MuxDireccion|salida[1]~7_combout\ & (!\secuenciador|MuxDireccion|salida[0]~9_combout\ & ((\secuenciador|MuxDireccion|salida[2]~4_combout\) # (!\secuenciador|MuxDireccion|salida[3]~2_combout\)))) # 
-- (!\secuenciador|MuxDireccion|salida[1]~7_combout\ & (!\secuenciador|MuxDireccion|salida[3]~2_combout\ & ((!\secuenciador|MuxDireccion|salida[2]~4_combout\))))
